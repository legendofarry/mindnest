...
class _StudentAppointmentsHeroCard extends StatelessWidget {
  const _StudentAppointmentsHeroCard({required this.profile});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF0B1B34), Color(0xFF123A63)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            '$firstName, track upcoming sessions, reschedule quickly, and keep your care timeline in one clean workspace.',
            style: const TextStyle(
              color: Colors.white,
              fontSize: 22,
              fontWeight: FontWeight.w800,
          ...
          const Wrap(
            ...
            runSpacing: 10,
            children: [
              _HeroMetaChip(label: 'Upcoming tracking'),
              _HeroMetaChip(label: 'Timeline view'),
              _HeroMetaChip(label: 'Fast reschedule'),
            ],
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 16, color: const Color(0xFFBEEBF2)),
          const SizedBox(width: 8),
          Text(
            label,
            style: const TextStyle(
